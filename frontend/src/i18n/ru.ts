export const ru = {
  ...
  auth: {
    ...
    demoHintRegister: 'Регистрация недоступна — подтверждение email не настроено. Чтобы попробовать приложение, войдите с демо-аккаунтом:',
    demoHintLogin: 'Хотите попробовать? Войдите с демо-аккаунтом:',
  ...
  chat: {
    ...
    emptyHeading: 'О чём думаете?',
    emptySubtitle: 'Задайте вопрос о ваших заметках',
    recentChats: 'Недавние',
    generationError: 'Ошибка генерации. Попробуйте ещё раз.',
    maxCharsHint: '{count}/4000',
    bulkNotes: '{count} заметок',
  },
