...
from app.registration.schemas import RegisterUserSchema
from app.registration.dto import RegistrationResult
...
async def test_register_user_success(uow_mock, monkeypatch):
    ...
    # Мок EmailFactory
    monkeypatch.setattr(
        "app.registration.service.EmailFactory.verification_email",
        AsyncMock()
    )
