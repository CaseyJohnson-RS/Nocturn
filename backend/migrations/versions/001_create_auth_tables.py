"""Create auth tables: users, refresh_tokens, verification_tokens
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("nickname", sa.String(32), unique=True, nullable=False),
    ...
    op.create_index("ix_verification_tokens_user_id_type", "verification_tokens", ["user_id", "type"])
